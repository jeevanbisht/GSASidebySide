...
- **Scenario Selection** — Choose from 4 coexistence deployment patterns
...
- **Tenant ID Integration** — Enter your tenant GUID to auto-populate tenant-specific bypass FQDNs
